...
import ThemeScitch from '@/components/theme-switch';
import ThemeContextProvoider from '@/context/theme-context';
    ...
    return (
        <html lang='en' className='!scroll-smooth'>
            ...
            >
                ...
                <div className='bg-[#fbe2e3] absolute -z-10 top-[-6rem] right-[11rem] h-[31.25rem] w-[50rem] rounded-full blur-[10rem] sm:w-[68.75rem] dark:bg-[#946263]'></div>
